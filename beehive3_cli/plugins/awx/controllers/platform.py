...
def AWX_ARGS(*list_args):
    orchestrator_args = [
        (['-O', '--orchestrator'], {'action': 'store', 'dest': 'orchestrator', 'help': 'awx platform reference label'})
    ]
...
class AwxPlatformController(BaseController):
    ...
    def pre_command_run(self):
        ...
        if label is None:
            ...
            if len(keys) > 0:
                ...
                raise Exception('No awx default platform is available for this environment. Select '
                                'another environment')
    ...
    @ex(
        help='get awx version',
        description='get awx version',
        arguments=AWX_ARGS()
    )
    def version(self):
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['-id'], {'help': 'organization id', 'action': 'store', 'type': str, 'default': None}),
            (['-name'], {'help': 'organization name', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    def org_get(self):
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['-id'], {'help': 'inventory id', 'action': 'store', 'type': str, 'default': None}),
            (['-name'], {'help': 'inventory name', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    def inventory_get(self):
        ...
        if oid is not None:
            ...
            self.app.render(res, headers=['id', 'name', 'organization', 'total_hosts', 'total_groups',
                                          'total_inventory_sources', 'created', 'modified'])
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['name'], {'help': 'inventory name', 'action': 'store', 'type': str, 'default': None}),
            (['organization'], {'help': 'organization id', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['id'], {'help': 'inventory source id', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['-inventory'], {'help': 'inventory id', 'action': 'store', 'type': str, 'default': None}),
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['name'], {'help': 'script inventory name', 'action': 'store', 'type': str, 'default': None}),
            (['organization'], {'help': 'organization id', 'action': 'store', 'type': str, 'default': None}),
            (['script'], {'help': 'script. Ex. #!/bin/bash\nsource /opt/beehive/bin/activate\n', 'action': 'store',
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['-id'], {'help': 'inventory group id', 'action': 'store', 'type': str, 'default': None}),
            (['-name'], {'help': 'inventory name', 'action': 'store', 'type': str, 'default': None}),
            (['-inventory'], {'help': 'inventory id', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    def inventory_group_get(self):
        ...
        if oid is not None:
            ...
            self.app.render(res, headers=['id', 'name', 'inventory', 'variables', 'created', 'modified'])
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['inventory'], {'help': 'inventory id', 'action': 'store', 'type': str, 'default': None}),
            (['name'], {'help': 'inventory group name', 'action': 'store', 'type': str, 'default': None}),
            (['-desc'], {'help': 'host description', 'action': 'store', 'type': str, 'default': None}),
            (['-vars'], {'help': 'host variables. ex: k1:v1,k2:v2', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    ...
    def ad_hoc_command_get(self):
        ...
        if oid is not None:
            ...
            self.app.render(res, headers=['id', 'name', 'module_name', 'module_args', 'status', 'started', 'finished',
                                          'elapsed'])
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['inventory'], {'help': 'inventory id', 'action': 'store', 'type': str, 'default': None}),
            (['credential'], {'help': 'credential id', 'action': 'store', 'type': str, 'default': None}),
            (['-verbosity'], {'help': 'verbosity', 'action': 'store', 'type': int, 'default': 0}),
        ])
    )
    def ad_hoc_command_add(self):
        ...
        extra_vars = {}
        res = self.client.ad_hoc_command.add(inventory_id, limit='', credential=credential_id, module_name='shell',
                                             module_args=module_args, verbosity=verbosity, extra_vars=extra_vars,
    ...
    def job_get(self):
        ...
        if oid is not None:
            ...
            self.app.render(res, headers=['id', 'type', 'playbook', 'launch_type', 'status', 'started', 'finished',
                                          'elapsed'])
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['id'], {'help': 'job id', 'action': 'store', 'type': str, 'default': None}),
            (['-query'], {'help': 'job event query. Comma separated k:v', 'action': 'store', 'type': str,
                          'default': None}),
        ])
    )
    def job_event_get(self):
        ...
        self.app.render(res, headers=['id', 'counter', 'task', 'event', 'event_display', 'event_data.task_action',
                                      'failed'], maxsize=200)
    ...
    def host_get(self):
        ...
        if oid is not None:
            ...
            self.app.render(res, headers=['id', 'name', 'inventory', 'enabled', 'created', 'modified'])
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['id'], {'help': 'host id', 'action': 'store', 'type': str, 'default': None}),
            (['group'], {'help': 'group id', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['-id'], {'help': 'credential id', 'action': 'store', 'type': str, 'default': None}),
            (['-name'], {'help': 'credential name', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    def credential_get(self):
        ...
        if oid is not None:
            ...
            self.app.render(res, headers=['id', 'name', 'organization', 'kind', 'created', 'modified'])

    @ex(
        help='get credential types',
        description='get credential types',
        arguments=AWX_ARGS([
            (['-id'], {'help': 'credential type id', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    def credential_type_get(self):
        ...
        if oid is not None:
            ...
            if self.is_output_text():
                ...
                self.c('\ninputs', 'underline')
                self.app.render(inputs, headers=['id', 'label', 'type', 'format', 'secret', 'multiline',
                                                 'ask_at_runtime', 'help_text'])
            else:
                self.app.render(res, details=True)
        else:
            res = self.client.credential.type_list(order_by='id')
            self.app.render(res, headers=['id', 'name', 'kind', 'namespace', 'managed_by_tower', 'created', 'modified'])
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['name'], {'help': 'credential name', 'action': 'store', 'type': str, 'default': None}),
            (['organization'], {'help': 'organization id', 'action': 'store', 'type': str, 'default': None}),
            (['username'], {'help': 'username', 'action': 'store', 'type': str, 'default': None}),
            (['-password'], {'help': 'password', 'action': 'store', 'type': str, 'default': None}),
            (['-key_data'], {'help': 'ssh key data file', 'action': 'store', 'type': str, 'default': None}),
            (['-key_unlock'], {'help': 'ssh key unlock', 'action': 'store', 'type': str, 'default': None}),
            (['-become'], {'help': 'become method', 'action': 'store', 'type': str, 'default': 'no_become'})
        ])
    )
    def credential_ssh_add(self):
        ...
        res = self.client.credential.add_ssh(name, organization, username, password=password, ssh_key_data=ssh_key_data,
                                             ssh_key_unlock=ssh_key_unlock, become=become)
    ...
    def project_get(self):
        ...
        if oid is not None:
            ...
            if self.is_output_text():
                ...
                self.app.render(jobs, headers=['id', 'type', 'launch_type', 'status', 'started', 'finished', 'elapsed'])
            else:
                self.app.render(res, details=True)
        else:
            name = self.app.pargs.name
            ...
            self.app.render(res, headers=['id', 'name', 'organization', 'status', 'scm_type', 'scm_url', 'scm_branch',
                                          'created', 'modified'])
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            ...
            (['organization'], {'help': 'organization id', 'action': 'store', 'type': str, 'default': None}),
            (['credential'], {'help': 'credential id', 'action': 'store', 'type': str, 'default': None}),
            (['scm_url'], {'help': 'scm url', 'action': 'store', 'type': str, 'default': None}),
            (['-scm_type'], {'help': 'scm type', 'action': 'store', 'type': str, 'default': 'git'}),
            (['-scm_branch'], {'help': 'scm branch', 'action': 'store', 'type': str, 'default': 'master'}),
            (['-scm_update_on_launch'], {'help': 'scm update on launch', 'action': 'store', 'type': bool,
                                         'default': True}),
        ])
    )
    def project_add(self):
        ...
        res = self.client.project.add(name, organization=organization, scm_type=scm_type, scm_url=scm_url,
                                      scm_branch=scm_branch, credential=credential,
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['-id'], {'help': 'project job id', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    def project_job_get(self):
        ...
        if oid is not None:
            ...
            self.app.render(jobs, headers=['id', 'name', 'type', 'status', 'job_tags', 'created', 'elapsed'])
    ...
    def project_job_event_get(self):
        ...
        self.app.render(events, headers=['id', 'type', 'event', 'counter', 'event_display'], maxsize=200)
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            ...
            (['-name'], {'help': 'template name', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    def template_get(self):
        ...
        if oid is not None:
            ...
            headers = ['id', 'name', 'inventory', 'project', 'job_type', 'playbook', 'status', 'last_job', 'created']
            fields = ['id', 'name', 'inventory', 'project', 'job_type', 'playbook', 'status',
                      'summary_fields.last_job.id', 'created']
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            ...
            (['playbook'], {'help': 'playbook', 'action': 'store', 'type': str, 'default': None}),
            (['-verbosity'], {'help': 'verbosity: 0 (Normal) (default), 1 (Verbose), 2 (More Verbose), 3 (Debug), '
                                      '4 (Connection Debug), 5 (WinRM Debug)', 'action': 'store', 'type': int,
                              'default': 0}),
        ])
    )
    def template_add(self):
        ...
        verbosity = self.app.pargs.verbosity
        res = self.client.job_template.add(name, 'run', inventory, project, playbook, ask_credential_on_launch=True,
                                           ask_variables_on_launch=True, ask_limit_on_launch=True, verbosity=verbosity)
        job_template = res['id']
    ...
    @ex(
        ...
        arguments=AWX_ARGS([
            (['id'], {'help': 'template id', 'action': 'store', 'type': str, 'default': None}),
            (['credentials'], {'help': 'comma separated credentials id', 'action': 'store', 'type': str,
                               'default': None}),
            (['-extras'], {'help': 'variables used when launching job template, k1:v1;k2:v2', 'action': 'store',
                           'type': str, 'default': None}),
        ])
    )
