...
class DnsController(BaseController):
        ...
        if oid is not None:
            ...
            if self.is_output_text():
                ...
                self.app.render(
                    res,
                    key="nameservers",
                    headers=["ip_addr", "fqdn", "start_nameserver"],
                )
    ...
    def zone_query(self):
        ...
        self.app.render(
            res,
            key="records",
            headers=["type", "start_nameserver", "ip_address", "base_fqdn"],
            maxsize=200,
        )
        ...
        arguments=PARGS(
            [
                ...
                (
                    ["-show_expired"],
                    {
                        "help": "if True show record DELETED",
                        "action": "store",
                        "type": str,
                        "default": None,
                    },
    ...
    def record_cname_add(self):
        ...
        resp = {"msg": "Create new record cname (%s, %s, %s)" % (name, host_name, zone.get("name"))}
        self.app.render(resp, headers=["msg"])
