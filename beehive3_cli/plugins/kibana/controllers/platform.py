...
class KibanaPlatformController(BaseController):
    ...
    def pre_command_run(self):
        ...
        if label is None:
            ...
            if len(keys) > 0:
                ...
                raise Exception('No kibana default platform is available for this environment. Select '
                                'another environment')
    ...
    def space_add(self):
        ...
        self.app.render(res, headers=['id', 'name', 'description', 'color', 'disabledFeatures', '_reserved'])
    ...
    @ex(
        ...
        arguments=KIBANA_ARGS([
            ...
            (['space_id'], {'help': 'space_id', 'action': 'store', 'type': str, 'default': None}),
        ])
    )
    def role_add(self):
