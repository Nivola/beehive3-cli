...
class AuthUserController(AuthChildController):
    ...
    @ex(
        ...
        arguments=PARGS([
            (['-id'], {'help': 'user uuid', 'action': 'store', 'type': str, 'default': None}),
            ...
            (['-desc'], {'help': 'user desc', 'action': 'store', 'type': str, 'default': None}),
    ...
    def get(self):
        ...
        if oid is not None:
            ...
            mappings = {'name': lambda n: '%' + n + '%', 'desc': lambda n: '%' + n + '%'}
            ...
            self.app.render(res, key='users', headers=self._meta.user_headers, fields=self._meta.user_fields)
    ...
    @ex(
        ...
        arguments=ARGS([
            ...
            (['-desc'], {'help': 'user description', 'action': 'store', 'action': StringAction, 'type': str,
                         'nargs': '+', 'default': ''}),
            (['-storetype'], {'help': 'can be DBUSER, LDAPUSER', 'action': 'store', 'type': str, 'default': 'DBUSER'}),
            (['-password'], {'help': 'user password. Set only for DBUSER', 'action': 'store', 'type': str,
                             'default': None}),
            (['-expirydate'], {'help': 'user expire date. Syntax yyyy-mm-dd', 'action': 'store', 'type': str,
                               'default': None}),
            (['-email'], {'help': 'email address', 'action': 'store', 'type': str, 'default': None})
        ])
    )
    ...
    @ex(
        ...
        arguments=ARGS([
            ...
            (['-desc'], {'help': 'user description', 'action': 'store', 'action': StringAction, 'type': str,
                         'nargs': '+', 'default': None}),
            (['-active'], {'help': 'user active', 'action': 'store', 'type': bool, 'default': True}),
            (['-provider'], {'help': 'authentication provider', 'action': 'store', 'type': str, 'default': None}),
            (['-password'], {'help': 'user password. Set only for DBUSER', 'action': 'store', 'type': str,
                             'default': None}),
            (['-expirydate'], {'help': 'user expire date. Syntax yyyy-mm-dd', 'action': 'store', 'type': str,
                               'default': None}),
