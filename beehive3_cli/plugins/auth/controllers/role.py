...
class AuthRoleController(AuthChildController):
    ...
    @ex(
        ...
        arguments=PARGS([
            ...
            (['-user'], {'help': 'role uuid', 'action': 'store', 'type': str, 'default': None}),
            (['-group'], {'help': 'group uuid', 'action': 'store', 'type': str, 'default': None}),
            (['-names'], {'help': 'name filter', 'action': 'store', 'type': str, 'default': None}),
            (['-alias'], {'help': 'role alias', 'action': 'store', 'type': str, 'default': None}),
    ...
    def get(self):
        ...
        if oid is not None:
            ...
            self.app.render(res, key='roles', headers=self._meta.role_headers, fields=self._meta.role_fields)
    ...
    @ex(
        ...
        arguments=ARGS([
            ...
            (['-desc'], {'help': 'role description', 'action': 'store', 'action': StringAction, 'type': str,
                         'nargs': '+', 'default': ''}),
        ])
    )
    def add(self):
