        ...
        arguments=PLATFORM_ARGS(
            [
                ...
                (
                    ["-check_host"],
                    {
                        "help": "list of comma separated host to check",
                        "action": "store",
                        "type": str,
                        "default": None,
                    },
        ...
        arguments=PLATFORM_ARGS(
            [
                ...
                (
                    ["-order"],
                    {
                        "help": "ield used to order records",
                        "action": "store",
                        "type": str,
                        "default": None,
                    },
