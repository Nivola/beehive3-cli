    ...
    def pre_command_run(self):
        ...
        if label is None:
            ...
            if len(keys) > 0:
                ...
                raise Exception(
                    "No datadomain default platform is available for this environment. Select " "another environment"
                )
    ...
    @ex(
        ...
        arguments=ARGS(
            [
                (
                    ["-port"],
                    {"help": "datadomain port", "action": "store", "default": 443},
                )
            ]
        ),
    )
        ...
        arguments=PARGS(
            [
                ...
                (
                    ["-nfs_id"],
                    {
                        "help": "data domain nfs exports id",
                        "action": "store",
                        "type": str,
                        "default": None,
                    },
        ...
        arguments=PARGS(
            [
                ...
                (
                    ["path"],
                    {
                        "help": "data domain nfs export path",
                        "action": "store",
                        "type": str,
                        "default": None,
                    },
