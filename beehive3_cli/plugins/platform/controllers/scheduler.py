...
def SCHED_ARGS(*list_args):
    scheduler_args = [
        ...
        (
            ["--entity"],
            {"action": "store", "dest": "entity", "help": "cmp entity class"},
        ),
    ]
...
class CmpSchedulerTaskController(ChildPlatformController):
    ...
    @ex(
        ...
        arguments=SCHED_PARGS(
            [
                ...
                (
                    ["-objid"],
                    {"help": "task entity objid", "action": "store", "type": str},
                ),
                (
                    ["-trace"],
                    {
                        "help": "task entity objid",
                        "action": "store",
                        "type": str,
                        "default": "true",
                    },
    ...
    def get(self):
        ...
        if oid is not None:
            ...
            if self.is_output_text():
                ...
                self.app.render(
                    steps,
                    headers=self._meta.step_headers,
                    fields=self._meta.step_fields,
                    maxsize=40,
                )
                ...
                if trace is True:
                    ...
                    transform = {"message": __transform}
                    self.app.render(
                        trace,
                        headers=self._meta.trace_headers,
                        fields=self._meta.trace_fields,
                        maxsize=1000,
                        transform=transform,
                    )
            else:
        ...
        arguments=SCHED_PARGS(
            [
                ...
                (
                    ["-v"],
                    {
                        "help": "verbose, if true print task steps as well",
                        "action": "store",
                        "type": str,
                        "default": True,
                    },
    ...
    def tree(self):
        ...
        def get_parent(oid):
            ...
            steps = task.pop("steps", [])
            item = {"task_id": oid, "alias": alias, "steps": steps}
            tasks.append(item)
    ...
    def log(self):
        ...
        match = [
            ...
            # {"match": {"data.api_id": {"query": task, "operator": "and"}}},
            {"match": {"data.opid": {"query": task, "operator": "and"}}},
        ]
        ...
        header = ["id", "type", "date", "data.response", "dest.pod", "data.op"]
        ...
        arguments=SCHED_PARGS(
            [
                ...
                (
                    ["-concurrent"],
                    {
                        "help": "number of concurrent task to run",
                        "action": "store",
                        "type": int,
                        "default": 1,
                    },
        ...
        arguments=SCHED_PARGS(
            [
                (
                    ["schedule"],
                    {
                        "help": "schedule config in json file",
                        "action": "store",
                        "type": str,
                    },
                ),
    ...
    @ex(
        ...
        arguments=SCHED_PARGS(
            [
                (
                    ["schedule"],
                    {"help": "schedule name", "action": "store", "type": str},
                ),
            ]
        ),
    )
