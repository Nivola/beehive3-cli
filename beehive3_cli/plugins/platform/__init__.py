...
import os
from beehive3_cli.plugins.platform.controllers.cmp import CmpController, CmpPostInstallController, \
    CmpTestController, CmpSubsystemController, CmpCustomizeController, CmpLog2Controller
from beehive3_cli.plugins.platform.controllers.nginx import NginxController
from beehive3_cli.plugins.platform.controllers.scheduler import CmpSchedulerController, CmpSchedulerTaskController, \
...
from .controllers.mariadb import MysqlController, MysqlTableController, MysqlSchemaController, MysqlUserController
